...
class block_ai_assistant_v2_edit_form extends block_edit_form {
    protected function specific_definition($mform): void {
        ...
        $mform->addElement('select', 'config_agent_key', get_string('agentkey', 'block_ai_assistant_v2'), $agents);
        $mform->setDefault('config_agent_key', (string)get_config('block_ai_assistant_v2', 'agent_key'));

        $mform->addElement('text', 'config_mainsubjectkey', get_string('mainsubjectkey', 'block_ai_assistant_v2'));
        $mform->setType('config_mainsubjectkey', PARAM_TEXT);
        $mform->setDefault('config_mainsubjectkey', (string)get_config('block_ai_assistant_v2', 'mainsubjectkey'));

        $mform->addElement('textarea', 'config_syllabusjson', get_string('syllabusjson', 'block_ai_assistant_v2'), 'rows="14" cols="70"');
